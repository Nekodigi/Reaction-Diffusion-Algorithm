...
void setupGUI() {
  ...
  posX += 50;
  controlP5.addSlider("fade", 0, 100, 0, posX, 1000, 30).setGroup(ctrl).getCaptionLabel().setColorBackground(color(360,80));
  posX += 50;
  controlP5.addSlider("lineFade", 0, 100, 0, posX, 1000, 30).setGroup(ctrl).getCaptionLabel().setColorBackground(color(360,80));
  posX += 50;
